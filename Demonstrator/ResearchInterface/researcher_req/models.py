...
class Request(models.Model):
    ...
    request_sent = models.DateTimeField('date sent', default = None)

    class RequestStatus(models.TextChoices):
        NOTSENT = 'NS', _('Request has not been sent')
        SENT = 'SE', _('Request has been sent')
        REPLIED = 'RE', _('Request has been fulfilled')
